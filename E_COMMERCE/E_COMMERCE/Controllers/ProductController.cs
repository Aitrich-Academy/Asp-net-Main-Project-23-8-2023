...
namespace E_COMMERCE.Controllers
{
    ...
    public class ProductController : ApiController
    {
        ...
        public HttpResponseMessage ProductInsert(Ent_Product product)
        {
            ...
            {
                Ent_User uToken = TokenManager.ValidateToken(authorization.Parameter);

                if (uToken != null && uToken.Id != null && uToken.role == "Admin" && ModelState.IsValid)
                {
            ...
            return Request.CreateResponse(HttpStatusCode.Unauthorized, "Unauthorized Usage");
        }
